...
Version  : 2.3.54
Release  : 60
URL      : https://cran.r-project.org/src/contrib/chron_2.3-54.tar.gz
Source0  : https://cran.r-project.org/src/contrib/chron_2.3-54.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571809817
